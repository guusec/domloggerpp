...
const updateUIBurp = (burpConfig) => {
    const statusText = document.getElementById("burp-status-text");
    const statusDiv = document.getElementById("burp-status");
    const enableBtn = document.getElementById("burp-enable-btn");
    const disableBtn = document.getElementById("burp-disable-btn");
    const burpURLInput = document.getElementById("burpURL");

    if (burpConfig.enabled) {
        statusText.innerText = "Enabled and active";
    ...
    if (burpURLInput) {
        burpURLInput.value = burpConfig.url || "http://localhost:8089/webhook";
    }
}
